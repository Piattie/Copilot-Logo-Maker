...
describe('Shape class validation', () => {
    test('should throw an error for invalid color format', () => {
        expect(() => new Shape('#12345G')).toThrow('Invalid color format.'); // Assuming hex validation
    });
});
